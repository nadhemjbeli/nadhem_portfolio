...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full relative overflow-x-hidden bg-os-bg scroll-smooth font-mono selection:bg-neon-primary selection:text-black">
