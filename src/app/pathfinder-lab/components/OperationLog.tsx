...
export default function OperationLog({ description, algorithmLabel }: OperationLogProps) {
  ...
  return (
    <div className="glass-panel border border-os-border/20 rounded-xl px-5 py-3 font-mono">
      ...
      <p className="text-[11px] text-neon-primary/80 leading-relaxed min-h-[1.5rem] break-words">
        {displayed}
        <span
